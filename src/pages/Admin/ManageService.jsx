    ...
    <div>
          ...
          >
            ...
            <div className="flex mt-5">
              <button
                ...
                className="bg-[#f86e9c] text-white px-5 py-2 mr-2 rounded-md"
              >
                Edit
              </button>
              <button
                onClick={() => handleDelete(service._id)}
                className="bg-[#f86e9c] text-white px-5 py-2 rounded-md"
              >
                Delete
              </button>
            </div>
      ...
      >
        ...
        <input
          ...
          className="border-2 border-[#f86e9c] p-2 rounded-md"
        />
        ...
        <button
          onClick={handleSave}
          className="bg-[#f86e9c] text-white px-5 py-2 my-5 rounded-md "
        >
          Save
        </button>
      </Modal>
