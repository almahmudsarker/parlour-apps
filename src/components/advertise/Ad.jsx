        ...
        <div className="flex flex-row py-8 gap-20">
          ...
          >
            <img
              ...
              src="https://github.com/abirhasan33/jerin-parlour-client/blob/main/src/Assests/Images/Image/washing.png?raw=true"
              alt="728x90"
            />
          </div>
          <div
          ...
          >
            ...
            <div className="flex mt-10">
              <p className="text-4xl font-bold text-left text-[#F63E7B] w-[110px] h-[60px] mt-5 mr-10">
                500+
              </p>
              <p className="text-4xl font-bold text-left text-[#F63E7B] w-[70px] h-[60px] mt-5">
                16+
              </p>
            </div>
            <div className="flex">
