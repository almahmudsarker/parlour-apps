...
const promotions = [
  {
    id: 1,
    title: "50% Off Haircuts",
    description: "Get a 50% discount on all haircut services this month!",
  },
  {
    id: 2,
    title: "Summer Beauty Special",
    description:
      "Enjoy our exclusive summer beauty package at a discounted price.",
  },
  {
    id: 3,
...
const Promotions = () => {
  return (
    <div className="bg-[#F63E7B] text-white py-12">
      <div className="container mx-auto text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {promotions.map((promo) => (
            ...
            >
              <IoMdRibbon className="text-6xl text-[#F63E7B] mx-auto" />
