      ...
      >
        ...
        <div>
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center px-4 py-2 mt-5  transition-colors duration-300 transform   hover:text-[#F63E7B] ${
                isActive ? "text-[#F63E7B]" : "text-gray-600"
              }`
            }
          >
          ...
          <button
            ...
            className="flex w-full items-center px-4 py-2 mt-5 text-gray-600 hover:text-[#F63E7B] transition-colors duration-300 transform"
          >
