        ...
        <div className="flex justify-between py-20">
          ...
          <div className="flex flex-col">
            ...
            <p className="w-full lg:w-80">
              Beauty Salon offers a wide array of services; ranging from
              multiple methodologies of hair care, hair treatments, skin
              therapy, Manicure, pedicure, waxing, threading and soothing body
